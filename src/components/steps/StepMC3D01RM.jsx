import mc3d01rmImg from "../../assets/Schema_MC3D01RM.jpg";

export default function StepMC3D01RM() {
  return (
    <div className="step-page">
      <div className="step-page-header">
        <h1 className="t-title2">Compteur supplémentaire MC3D01RM</h1>
      </div>

      <div className="step-page-section">
        <p className="list-header">Compteur MC3D01RM</p>
        <div style={{ padding: "0 16px" }}>
          <div className="list-group" style={{ padding: 16 }}>
            <div style={{ display: "flex", justifyContent: "center", marginBottom: 12 }}>
              <img
                src={mc3d01rmImg}
                alt="Compteur MC3D01RM"
                onClick={() => window.open(mc3d01rmImg, "_blank")}
                style={{ width: "40%", borderRadius: 8, cursor: "zoom-in", display: "block" }}
              />
            </div>
            <div style={{ display: "flex", justifyContent: "center", gap: 6, flexWrap: "wrap" }}>
              <span className="tag-pill">↔ Traversant · Triphasé · 230/400V</span>
